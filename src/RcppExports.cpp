...
// plot_irr
bool plot_irr(Nullable<DataFrame> points_df, Nullable<CharacterVector> mesh_cv, bool doomhud, char video_driver);
RcppExport SEXP Rirrlicht_plot_irr(SEXP points_dfSEXP, SEXP mesh_cvSEXP, SEXP doomhudSEXP, SEXP video_driverSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(plot_irr(points_df, mesh_cv, doomhud, video_driver));
